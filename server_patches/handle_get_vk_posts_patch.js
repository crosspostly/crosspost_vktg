/* PATCH: Enhance handleGetVkPosts to accept either numeric vk_group_id or screen_name
 * Behavior:
 * - If payload.vk_group_id is numeric (with optional leading -), use as is
 * - Else, if payload.vk_group_id is non-numeric string, treat it as screen_name and resolve via resolveVkScreenName()
 * - Else, if payload.screen_name provided, resolve via resolveVkScreenName()
 * - Returns friendly errors with details
 */
